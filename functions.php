...
function starting_theme_setup() {
	...
	register_nav_menus( array(
		'mega_menu' => esc_html__( 'Mega Menu', 'starting-theme' ),
		'top-nav' => esc_html__( 'Top Nav', 'starting-theme' ),
		'footer-nav' => esc_html__( 'Footer Navigation', 'starting-theme' ),
	) );
...
require_once get_template_directory() . '/functions/acf-widget.php';

// Register Custom Navigation Walker
	require_once get_template_directory() . '/functions/wp_bootstrap4-mega-navwalker.php';
            ...
            foreach ( $items as $item ) {
                if ( in_array( $css_class, $item->classes ) ) {
                    register_sidebar( array(
                        ...
                        'before_widget' => '<li id="%1$s" class="mega-menu-item col-6 col-md-3">',
                        'after_widget' => '</li>',
